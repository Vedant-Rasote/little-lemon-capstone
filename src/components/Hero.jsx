  ...
  return (
    <div className="row flex-lg-row-reverse align-items-center g-5 pt-5" id='home'>
      <div className="col-10 col-sm-8 col-lg-6 mx-auto">
        <img src={heroWithSilhouette} className="d-block img-fluid" alt="Image of Little Lemon restaurant" loading="lazy" />
      </div>
      <div className="col-lg-6 text-center text-lg-start" style={{ backgroundImage: `url(${bgHeroText})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
        ...
        <button type="button" className="btn btn-warning rounded-pill px-3 mr-2" aria-label="Order Online">Order Online</button>
        <Link to='/booking'>
          <button type="button" className="btn btn-dark rounded-pill px-3 mx-2" aria-label="Reserve a Table">Reserve Table</button>
        </Link>
      </div>
    </div>
  );
