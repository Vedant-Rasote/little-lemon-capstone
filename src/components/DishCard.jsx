...
const DishCard = (props) => {
    const { imageSource, imageAltText, title, description, price, starRating, reviewsCount } = props;

    const filledStars = Array.from({ length: starRating }, (_, index) => (
        <StarFill className='me-1' key={index} role="img" aria-label="Filled Star" />
    ));

    const emptyStars = Array.from({ length: 5 - starRating }, (_, index) => (
        <Star className='me-1' key={index} role="img" aria-label="Empty Star" />
    ));
            ...
            <Card.Body className='text-center'>
                ...
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <div className="d-flex align-items-center">
                        <button className="btn btn-dark rounded-circle p-2 lh-1 mx-2" type="button" aria-label="Add to Favorites">
                        ...
                        <button className="btn btn-dark rounded-circle p-2 lh-1 mx-2" type="button" aria-label="Add to Cart">
